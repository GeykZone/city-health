...
<button type="button" id="current_year" style="margin-right: 10px;" class="border-0 bg-transparent"><span class="fa-solid text-light"></span></button>Health Profiles Graphical Statistic
</div>
  ...
  <div class="col-lg-6 col-md-12 mb-3 text-md-start align-content-center dropdown-center">
...
<div class=" container-fluid mt-3">
  <div class="row ">
    ...
    <span class="fa-regular me-3" style="margin-top: 2px;"></span><h6 class=""><span id="map_cases"></span><span id="map_from"></span><span id="map_to"></span><span id="map_disease"></span><span id="map_gender"></span></h6>
    </div>
  </div>
</div>
...
<!--chart 2-->
<div class="row chart_container mb-3 mt-5" style="display: block;">
<div class="col-md-12">
<div class="card border-0 mb-4 shadow-sm remove_rounded">

<div class="bg-info card-header border-0 shadow-sm text-bg-primary" id="disease_menu_tittle" style=" font-weight:500;">
<button type="button" id="disease_current_year" style="margin-right: 10px;" class="border-0 bg-transparent"><span class="fa-solid text-light"></span></button>Health Diseases Graphical Statistic
</div>

  <div class="card-body border-0 shadow-sm remove_rounded"  id="disease_wrapper" >

  <div class="container-fluid mb-1 ">
  <div class="row">

  <div class="col-lg-6 col-md-12 mb-3 text-md-start align-content-center dropdown-center">
        <a style="padding-top: 7px; padding-bottom: 7px;" class=" border-0 shadow-sm addbtn add-brgy px-3 fw-bolder" id="disease_sort_cases" role="button" >SORT <span class="fa-solid ms-1 fa-sort"></span></a>
  </div>
  ...
  <a style="padding-top: 7px; padding-bottom: 7px;" class=" border-0 shadow-sm mb-3 addbtn add-brgy px-3 fw-bolder" id="disease_filter_graph" data-coreui-toggle="modal" href="#filter-map" role="button" >FILTER <span class="fa-solid ms-1 fa-filter"></span></a>
  </div>
...
<div  class="mb-3" id="disease_hp_chart_row" style="min-height: 300px;  min-width:1200px;">
<canvas class=""  id="disease_hpChart"   style="width:100%;  max-height:580px ;"></canvas> 
</div>
...
<div class=" container-fluid mt-3">
  <div class="row ">
    <div class="col-12 d-flex text-dark" style=" opacity: 0.65;">
    <span class="fa-regular me-3" style="margin-top: 2px;"></span><h6 class=""><span id="disease_map_cases"></span><span id="disease_map_from"></span><span id="disease_map_to"></span><span id="disease_map_brgy"></span><span id="disease_map_gender"></span></h6>
    </div>
  </div>
</div>
