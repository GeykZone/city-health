...
<button type="button" id="current_year" style="margin-right: 10px;" class="border-0 bg-transparent"><span class="fa-solid text-light"></span></button>Time Span Graphical Statistic
</div>
...
<div class=" container-fluid mt-3">
  <div class="row ">
    ...
    <span class="fa-regular me-3" style="margin-top: 2px;"></span><h6 class=""><span id="map_cases"></span><span id="map_disease"></span><span id="map_from"></span><span id="map_to"></span><span id="map_barangay"></span><span id="map_gender"></span><span>.</span></h6>
    </div>
  </div>
</div>
...
<!--scripts-->
<script id="manage_user" src="effects/time-span.js" ></script>
<!--scripts end-->
