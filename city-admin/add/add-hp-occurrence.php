...
#occurence .modal-confirm .modal-footer a {
	color: #999;
}		
#occurence .modal-confirm .icon-box {
	width: 80px; 
	height: 80px;
	margin: 0 auto;
	border-radius: 50%;
...
#occurence .modal-confirm .icon-box i {
	color: #ffc137;
	font-size: 46px;
	display: inline-block;
	margin-top: 13px;
}
#occurence .modal-confirm .btn, .modal-confirm .btn:active {
	color: #fff;
	border-radius: 4px;
	background: #60c7c1;
...
#occurence .modal-confirm .btn-secondary {
	background: #c1c1c1;
}
#occurence .modal-confirm .btn-secondary:hover, .modal-confirm .btn-secondary:focus {
	background: #a8a8a8;
}
#occurence .modal-confirm .btn-danger {
	background: #ffc137;
}
#occurence .modal-confirm .btn-danger:hover, .modal-confirm .btn-danger:focus {
	background: #ffa837;
}
...
<div id="occurence" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"> 
	<div class="modal-dialog  modal-md modal-dialog-centered modal-confirm modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-center">
				...
				<button class="border-0 shadow-sm btn btn-danger fw-bolder" id="accept" data-coreui-dismiss="modal" aria-label="Close">Yes</button>
			</div>
		</div>
	</div>
</div> 
