    ...
    ?>
      <tr class="bg-tr align-middle">
        ...
        <td>
          ...
          if($admin_status == 0)
          {
            ?> <i class="edit_barangay_value btn_icon fas fa-unlock" href="#activate_barangay_admin" data-coreui-toggle="modal" id="activate_barangay_admin_value" role="button"></i><?php
          }
          else
          {
            ?><i class="edit_barangay_value btn_icon fas fa-lock" href="#deactivate_barangay_admin" data-coreui-toggle="modal" id="deactivate_barangay_value" role="button"></i><?php
          }
          ?>
