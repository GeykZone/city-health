...
if ($result->num_rows > 0)
{
    while($row = $result->fetch_assoc())
    {
        ...
        if($total_hp == 1)
        {
            $get_disease_names[] = $total_hp." documented health case caused by ".$row['disease_name'].".";
        }
        else{

            $get_disease_names[] =  $total_hp." documented health cases caused by ".$row['disease_name'].".";
        }
