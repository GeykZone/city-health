...
<div class="card border-0 mb-4 shadow-sm remove_rounded">
  ...
  <div class="card-body border-0 shadow-sm remove_rounded"  id="wrapper" >
      ...
      <a id="toggle_chart1" >
      <span style="color: #294168bf; margin-right: 10px;" class=" fa-solid align-content-center"></span> List of Inactive Health Cases
      </a>
      </div>
      ...
      <table class="table table-striped table-borderless table-condensed w-100" id="hp_table"> 
