  ...
  <div class="modal-dialog modal-dialog-centered" >
    <div class="modal-content">
      ...
      <div class="mb-3">
        ...
        <input  type="date" id="range_from" class="form-control   barangay-form text-sm-start shadow-sm"  placeholder="Min Date">
        <div class="invalid-feedback">
        Invalid min date.
        </div>
        </div>
        ...
        <input  type="date" id="range_to" class="form-control   barangay-form text-sm-start shadow-sm"  placeholder="Max Date">
        <div class="invalid-feedback">
        Invalid max date.
        </div>
        </div>
