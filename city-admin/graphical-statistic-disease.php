...
<li class="breadcrumb-item active"><span>Total Disease Stats</span></li>
</ol>
</nav>
</div>
</header>
...
<div class="row chart_container mb-3" style="display: block;">
  ...
  <button type="button" id="current_year" style="margin-right: 10px;" class="border-0 bg-transparent"><span class="fa-solid text-light"></span></button>Total Disease Stats Graphical Format
  </div>
...
<div class="card border-0 mb-4  shadow-sm remove_rounded">
  ...
  <div class="bg-info card-header border-0 shadow-sm text-bg-primary" id="menu_tittle" style=" font-weight:500;">
  <button type="button" id="current_year" style="margin-right: 10px;" class="border-0 bg-transparent"><span class="fa-solid text-light"></span></button>Total Disease Stats Tablur Format
  </div>  
  ...
  <div class="card-body border-0 shadow-sm remove_rounded"  id="wrapper" >
      ...
      <table class="table table-striped table-borderless table-condensed  mb-0 w-100" id="barangay_health_statistic"> 
        ...
        <tfoot class=" table-secondary fw-semibold shadow-sm" id="th_1">
          <tr class="align-middle" >
            <td id="Diagnosis"   style="width:150px;"></td>
