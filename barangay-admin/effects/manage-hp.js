...
{
selectize_barangay_id = my_barangay_id
  ...
  "buttons": [
    {
        ...
        messageTop: 'Barangay '+my_barangay_name+' Health Profiles',
...
$("#add_hp_btn").click(function () {
  ...
  if (fullname_txt.trim().length === 0) //check if value is empty
    {
...
function get_hp_table_cell_value()
{
  ...
  $("#hp_table").on('click','.update_hp_value',function(){
    ...
    var update_diagnosis_date = new Date(col7)
